...
export default function ProgressTab({
  ...
  return (
    <div className="flex flex-col h-[calc(100dvh-7rem)] md:h-[calc(100dvh-2rem)]">
      ...
      <div className="flex-1 min-h-0 mx-4 mb-4 mt-3 rounded-xl border-2 border-black dark:border-slate-600 shadow-[3px_3px_0_0_#000] dark:shadow-[3px_3px_0_0_#475569] overflow-hidden">
        <Constellation
          nodes={nodes}
          edges={edges}
          clusters={clusters}
