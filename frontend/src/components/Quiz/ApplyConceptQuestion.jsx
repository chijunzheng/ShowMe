  ...
  return (
    <div className="w-full max-w-2xl mx-auto animate-fade-in">
      ...
      <div className="relative mb-6">
        ...
        ">
          {/* Scenario label */}
          <div className="absolute -top-3 left-4 px-2 bg-indigo-50 dark:bg-gray-900 rounded">
            <span className="text-indigo-600 dark:text-indigo-400 text-sm font-medium flex items-center gap-1.5">
